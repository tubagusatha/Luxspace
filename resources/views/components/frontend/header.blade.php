       ...
       <div class="w-auto">
         <ul class="items-center flex">
           <li class="ml-6 block md:hidden">
             <button id="menu-toggler" class="relative flex z-50 items-center justify-center w-8 h-8 text-black {{ \Route::current()->getname() == 'index' ? 'md:text-white' : '' }} focus:outline-none">
           ...
           <li class="ml-6">
             <a id="header-cart" class="flex items-center justify-center w-8 h-8 text-black {{ \Route::current()->getname() == 'index' ? 'md:text-white' : '' }}" href="{{ route('cart') }}">
